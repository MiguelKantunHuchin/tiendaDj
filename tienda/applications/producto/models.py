...
class Product(TimeStampedModel):
    ...
    man = models.BooleanField("Para Hombre", default=True)  # es solo para mujer
    woman = models.BooleanField("Para Mujer", default=True)  # es para varon
    weight = models.DecimalField("Peso", max_digits=5, decimal_places=2, default=1)
    price_purchase = models.DecimalField(
        "Precio de Compra", max_digits=10, decimal_places=3
    )
